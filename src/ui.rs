...
fn build_add_event_ui(state: &UiState) -> ui::Element {
    ...
    let on_index_yes = ui::Element::new(ui::ElementType::Button, Some("是"))
        ...
        .padding_bottom(8)
        .padding_left(25)
        .bg(if state.event_data.on_index { "#424243" } else { "#2A2A2D" })
        .margin_right(5);
    ...
    let if_staring_day_yes = ui::Element::new(ui::ElementType::Button, Some("是"))
        ...
        .padding_bottom(8)
        .padding_left(25)
        .bg(if state.event_data.if_staring_day { "#424243" } else { "#2A2A2D" })
        .margin_right(5);
    ...
    container
        ...
        .child(on_index_container.child(on_index_label).child(on_index_buttons.child(on_index_yes).child(on_index_no)))
        .child(if_staring_day_container.child(if_staring_day_label).child(if_staring_day_buttons.child(if_staring_day_yes).child(if_staring_day_no)))
...
fn build_modify_event_ui(state: &UiState) -> ui::Element {
    ...
    let on_index_yes = ui::Element::new(ui::ElementType::Button, Some("是"))
        ...
        .padding_bottom(8)
        .padding_left(25)
        .bg(if state.modify_event_data.on_index { "#424243" } else { "#2A2A2D" })
        .margin_right(5);
    let on_index_no = ui::Element::new(ui::ElementType::Button, Some("否"))
    ...
    let if_staring_day_yes = ui::Element::new(ui::ElementType::Button, Some("是"))
        ...
        .padding_bottom(8)
        .padding_left(25)
        .bg(if state.modify_event_data.if_staring_day { "#424243" } else { "#2A2A2D" })
        .margin_right(5);
    let if_staring_day_no = ui::Element::new(ui::ElementType::Button, Some("否"))
